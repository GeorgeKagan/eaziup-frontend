    ...
    public ngOnInit() {
        this.route.data.subscribe((data) => {
            ...
            this.sidebarItems = [
                ...
                {
                    title: 'Delivery',
                    body: this.datePipe.transform(ProjectService.calculateDeliveryDate(this.project.start_date, this.project.milestones))
                },
                ...
                {title: 'Compensation', body: compensationBody}
            ];
        });
    }
